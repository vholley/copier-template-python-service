...
2. Draft `intent.md` from `templates/intent.md`. Fill What and Why from the engineer's words. Non-goals is mandatory: list at least one thing this item will not do. Done means: observable outcomes the requester would accept.
